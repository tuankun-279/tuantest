...
public class CheckmateDetector {
    ...
    public boolean blackCheckMated() {
        ...
        if (!this.blackInCheck()||canEvade(wMoves, bk)||canCapture(bMoves, threats, bk)||canBlock(threats, bMoves, bk)) {return false;}
    ...
    public boolean whiteCheckMated() {
        ...
        if (!this.whiteInCheck()||canEvade(bMoves, wk)||canCapture(wMoves, threats, wk)||canBlock(threats, wMoves, wk)){ return false;}
